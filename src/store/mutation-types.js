...
export const RECEIVE_CATEGORYS = 'receive_categorys'//接收商品分类信息
...
export const INCREMENT_FOOD_COUNT = 'increment_food_count' // 食物加1
export const DECREMENT_FOOD_COUNT = 'decrement_food_count' // 食物减1
